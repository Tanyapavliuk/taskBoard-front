...
export const SearchBoard: React.FC<Props> = ({ onFindBoard, onAddClick }) => {
  ...
  return (
    <div className="container flex flex-col gap-4 sm:flex-row items-center justify-between">
      <div className="order-2 w-full sm:w-1/2 flex gap-3 items-center">
      ...
      <button onClick={onAddClick} className="order-1 rounded-lg relative w-40 h-10 cursor-pointer flex items-center border border-green-500 bg-green-500 group hover:bg-green-500 active:bg-green-500 active:border-green-500 overflow-hidden">
